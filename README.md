...
You can choose two options — without or with CLI. We recommend to use CLI's SVN because it is quicker like a MIllenium Falcon.  
...
GPL3 © Suru++ Lubuntu by Gustavo Costa.
